...
import { CATEGORY_LABELS, DURATION_LABELS, type HelpRequest, type RequestCategory } from '../../types'
...
export default function VolunteerHome() {
  ...
  useEffect(
    () => subscribeToOpenRequests(setRequests, (error) => setLoadError(error.message)),
    [],
  )
